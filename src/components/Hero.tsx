  ...
  return (
    <section className="relative min-h-screen overflow-hidden flex items-center justify-center" style={{ backgroundColor: '#E6E6FA' }}>
      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10 pt-12">
        ...
        <div className="mt-24">
          <h3 className="text-2xl md:text-3xl font-semibold italic text-center mb-4 font-cormorant-garamond" style={{ color: '#003f6a' }}>
            Quick Links
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-0">
            <Card className="group px-0 py-6 bg-card/65 border-2 border-border hover:border-primary/50 hover:shadow-glow transition-all duration-300 hover:-translate-y-2 cursor-pointer flex items-center justify-center rounded-none">
              <h4 className="text-lg font-semibold text-center font-afacad-flux px-0.5" style={{ color: '#003f6a' }}>Consulting Services</h4>
            </Card>
            <Card className="group px-0 py-6 bg-card/65 border-2 border-border hover:border-primary/50 hover:shadow-glow transition-all duration-300 hover:-translate-y-2 cursor-pointer flex items-center justify-center rounded-none">
              <h4 className="text-lg font-semibold text-center font-afacad-flux px-0.5" style={{ color: '#003f6a' }}>Teaching Resources</h4>
            </Card>
            <Card className="group px-0 py-6 bg-card/65 border-2 border-border hover:border-primary/50 hover:shadow-glow transition-all duration-300 hover:-translate-y-2 cursor-pointer flex items-center justify-center rounded-none">
              <h4 className="text-lg font-semibold text-center font-afacad-flux px-0.5" style={{ color: '#003f6a' }}>Partners</h4>
            </Card>
            <Card className="group px-0 py-6 bg-card/65 border-2 border-border hover:border-primary/50 hover:shadow-glow transition-all duration-300 hover:-translate-y-2 cursor-pointer flex items-center justify-center rounded-none">
              <h4 className="text-lg font-semibold text-center font-afacad-flux px-0.5" style={{ color: '#003f6a' }}>Contact</h4>
            </Card>
          </div>
        </div>
      </div>
