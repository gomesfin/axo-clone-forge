      ...
      <div className="container mx-auto bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/80 border border-border/50 rounded-xl md:rounded-2xl shadow-hover">
        <div className="px-2 md:px-5 py-1 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6 lg:gap-8 xl:gap-10 -mr-2 md:-mr-8">
            ...
            <a href="#blog" className="text-base lg:text-xl xl:text-2xl hover:opacity-70 transition-all duration-300 cursor-pointer whitespace-nowrap" style={{ color: '#003f6a' }}>
              Blog
            </a>
            <a href="#resources" className="text-base lg:text-xl xl:text-2xl hover:opacity-70 transition-all duration-300 cursor-pointer whitespace-nowrap" style={{ color: '#003f6a' }}>
              Resources
            </a>
            <a href="#partners" className="text-base lg:text-xl xl:text-2xl hover:opacity-70 transition-all duration-300 cursor-pointer whitespace-nowrap" style={{ color: '#003f6a' }}>
              Partners
            </a>
            <a href="#about" className="text-base lg:text-xl xl:text-2xl hover:opacity-70 transition-all duration-300 cursor-pointer whitespace-nowrap" style={{ color: '#003f6a' }}>
              About
            </a>
            <Button
              variant="hero" 
              size="lg" 
              asChild 
              className="cursor-pointer font-abeezee text-sm lg:text-base px-3 lg:px-6 py-2 lg:py-3" 
