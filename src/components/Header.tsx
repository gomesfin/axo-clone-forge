...
export const Header = () => {
  return (
    <header className="fixed top-2 md:top-4 left-0 right-0 z-50 px-2 md:px-4">
      <div className="container mx-auto max-w-[104rem] bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/80 border border-border/50 rounded-xl md:rounded-2xl shadow-hover">
